...
const Footer = () => {
    ...
    return (
        <div className="px-4 md:px-16 lg:px-24 max-w-screen-2xl mx-auto mt-24 bg-primary/10">
            <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-gray-500/30 text-gray-500">
                <div>
                    <img className="w-34 md:w-32" src={assets.logo} alt="log0" />
            ...
            <p className="py-4 text-center text-sm md:text-base text-gray-600">
                Copyright {new Date().getFullYear()} © Avinash Saini All Right Reserved.
            </p>
        </div>
    );
};
