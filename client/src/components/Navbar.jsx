...
const Navbar = () => {
    ...
    return (
        <nav className="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b border-gray-300 bg-white relative transition-all ">
                ...
                {!user ? (<button onClick={() => setShowUserLogin(true)} className="cursor-pointer px-8 py-2 bg-primary hover:bg-primary-dull transition text-white rounded-full">
                    ...
                    : (
                        <div className='relative group'>
                            ...
                            <ul className='hidden group-hover:block absolute top-10 right-2 bg-white shadow border border-gray-200 
            ...
            {/* Mobile Menu */}
            {open && (
                <div className={`${open ? 'flex' : 'hidden'} absolute top-[60px] right-0 w-full bg-white shadow-md py-4 flex-col items-end gap-2 px-5 text-sm md:hidden`}>
